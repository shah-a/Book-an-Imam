  ...
  return (
    <header className="Header mt-5 flex justify-between items-center">
      ...
      <nav className="md:flex hidden">
        <a href="/?search=khutbah" className="p-2 hover:text-amber-500">Khutbah</a>
      ...
      {isMenuOpen && (
        <div className="absolute top-12 right-3 bg-white text-black  shadow-md mt-2 py-2 md:hidden">
          <a href="/?search=khutbah" className="block p-2 hover:text-amber-500">Khutbah</a>
          <a href="/?search=nikkah" className="block p-2 hover:text-amber-500">Nikkah</a>
          <a href="/?search=consultation" className="block p-2 hover:text-amber-500">Consultation</a>
        </div>
      )}
    </header>
  );
